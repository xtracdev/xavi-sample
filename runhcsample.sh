...
./xavisample add-server -address localhost -port 4545 -name quotesvr1 -health-check-interval 5000 -health-check-timeout 2000 -health-check http-get -ping-uri /
./xavisample add-server -address localhost -port 4646 -name quotesvr2 -health-check-interval 5000 -health-check-timeout 2000 -health-check http-get -ping-uri /
./xavisample add-server -address localhost -port 4747 -name quotesvr3 -health-check-interval 5000 -health-check-timeout 2000 -health-check http-get -ping-uri /
